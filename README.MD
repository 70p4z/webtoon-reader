...
# 📖 Vibe Coded Webtoon Reader (Flask)
...
![episodes](sample/episodes.png?raw=true "Episodes")

### Vertical scrolling an episode
![reader](sample/reader.png?raw=true "Reader")

### Admin view (manage user, run manual scans)
![admin](sample/admin.png?raw=true "Admin")
...
- Click navigation:
- Tap upper half → scroll up
- Tap lower half → scroll down
...
- Episode name
- **80×80 thumbnail** (first page)
- Read / resume indicators
- Clean mobile and responsive layout

---

### ⚙️ Availability & Moderation (Future-proofed)
